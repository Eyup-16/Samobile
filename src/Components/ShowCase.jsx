...
function ShowCase() {
  ...
  <div className="relative w-full max-w-screen-xl px-4 flex justify-center"> {/* Container for alignment */}
    <div className="flex gap-4 flex-wrap flex-col max-w-3xl text-center items-center "> {/* Flex parent for h1/p */}
      <span></span>
      <span className="text-[14px] font-semibold text-[#CACBCD] span cursor-pointer"> {/* Small span above h1 */}
      ...
      <button className="relative bg-[#fff] text-black px-8 py-3 rounded-lg font-semibold cursor-pointer mt-3 hover:bg-[#e8e8e8] transition-colors duration-300 w-fit"> {/* Call-to-action button */}
        Get Started Now
      </button>
    </div>
  </div>
