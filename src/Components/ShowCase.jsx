...
function ShowCase() {
  return (
    <section className='relative h-screen flex items-center justify-center text-white shadow-[inset_0px_2px_4px_0px_rgba(0,_0,_0,_0.3)]'>
  ...
  <div className="absolute w-full max-w-screen-xl px-4 flex justify-center"> {/* Container for alignment */}
    <div className="flex gap-4 flex-wrap flex-col max-w-3xl text-center items-center "> {/* Flex parent for h1/p */}
      <span></span>
      <span className="text-lg font-semibold text-[#CACBCD] "> {/* Small span above h1 */}
